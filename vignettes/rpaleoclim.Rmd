...
[PaleoClim](http://paleoclim.org) [@brown2018] is a set of free, high resolution paleoclimate surfaces covering the whole globe.
...
Data on current and Last Glacial Maximum climate is derived from [CHELSA](https://chelsa-climate.org/) [@karger2017] and reprocessed by PaleoClim to match their format; it is available at up to 30 seconds resolution.
