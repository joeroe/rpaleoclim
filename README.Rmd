...
This package provides a simple interface for downloading PaleoClim data in R, with support for spatial queries and caching.
...
`paleoclim()` downloads data from PaleoClim with the desired period and resolution and reads it into R as a [SpatRaster](https://rspatial.org/spatial-terra/8-rastermanip.html) object.
...
```{r paleoclim-crop-demo, message=FALSE}
